                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ asset('assets/css/style.css') }}" alt="" height="20">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror"  id="username" name="email" placeholder="Entrer votre email">
                                        @error('email')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Solution  <i class="mdi mdi-heart text-danger"></i> Logistique </p>
                    </div>
                </div>
            </div>
        </div>
