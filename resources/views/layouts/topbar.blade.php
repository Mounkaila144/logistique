    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <span class="fs-24 fw-bold">Solution logistique</span>
                        </span>
                        <span class="logo-lg">
                            <span class="fs-24 fw-bold">Solution logistique</span>
                        </span>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <form method="POST" action="{{ route('notifications.markAllAsRead') }}" id="markAllAsReadForm">
                        @csrf
                        <button type="submit" class="d-none" id="markAllAsReadButton"></button>
                    </form>
                    <button class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false" data-bs-target="#notificationDropdown">
            ...
            <span class="visually-hidden">unread messages</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown" style="overflow: auto;height: 80vh">

                        @foreach (auth()->user()->unreadNotifications as $notification)
                                <div data-simplebar style="max-height: 300px;     background-color: aliceblue;" class="pe-2 ">
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            @if ($notification->notifiable instanceof \App\Models\Client)
                                            <img src="{{URL::asset('build/images/users/avatar-3.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            @else
<i class="mdi mdi-truck "></i>                                            @endif
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
{{--                                                    <h6 class="mt-0 mb-1 fs-13 fw-semibold">{{  $client->nom . " " . $client->prenom }}</h6>--}}
                                                </a>
                                                <div class="fs-13 text-muted">
                                                    <p class="mb-1">{{ $notification->data['message'] }}</p>
                                                </div>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
{{--                                                    <span><i class="mdi mdi-clock-outline"></i> {{\Carbon\Carbon::parse($client->date_remboursement)->isoFormat('dddd D/M/YYYY')}}</span>--}}
                                                </p>
                                            </div>
                                            <div class="px-2 fs-15">
                                                <div class="form-check notification-check">
                                                    <i class="mdi mdi-check-all fs-24"></i><br> <span class="text-danger fs-12">new</span>
                                                </div>
...
{{--                                                    <span><i class="mdi mdi-clock-outline"></i> {{\Carbon\Carbon::parse($client->date_remboursement)->isoFormat('dddd D/M/YYYY')}}</span>--}}
                                            ...
                                            <div class="px-2 fs-15">
                                                <div class="form-check notification-check">
                                                    <i class="mdi mdi-check-all fs-24 text-info"></i><br><span class="text-info fs-12">lu</span>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        var dropdown = document.querySelector('#notificationDropdown');
                        var form = document.querySelector('#markAllAsReadForm');
                        var button = document.querySelector('#markAllAsReadButton');
